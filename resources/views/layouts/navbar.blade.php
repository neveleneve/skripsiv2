                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal">Log
                                    Out</button></li>
                        </ul>
                    </li>
                @else
                    <li class="nav-item">
                        <div class="d-grid gap-2">
                            <a href="{{ route('login') }}"
                                class="fw-bold btn btn-sm btn-outline-success me-0 me-lg-2 my-2 my-lg-0">
                                Sign In
                            </a>
                        </div>
                    </li>
